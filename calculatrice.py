...
# fonction permettant à l'utilisateur d'entrer les deux nombres  
def input_two_number():
    num1 = float(input("Entrez le premier nombre : "))
    num2 = float(input("Entrez le deuxième nombre : "))
    return num1, num2

# fonction d'affichage des choix de l'utilisateur avec vérification d'erreur de choix
...
# fonctions de réalisation des opérations
def sum(a, b):
    return a + b
...
# fonction de calcul en fonction du choix de l'utilisateur
...
# définition du point d'entrée principal du programme
